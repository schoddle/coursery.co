...
describe('Coursery Util JS Test Suite', function () {
    ...
    describe('1. Test Amazon Util Behavior', function () {
        ...
        describe('Test Create Clean Affiliate URL Scenarios', function () {
            it('Format a clean Affiliate Amazon URL', function () {
                expect(AmazonUtils.createCleanAffiliateURL('https://www.amazon.com/MintBox-IPC-D2x2-C3337NL-H500-WB-XLM-FM4U-BMint-2-Desktop/dp/B00EONR674')).toEqual('https://www.amazon.com/MintBox-IPC-D2x2-C3337NL-H500-WB-XLM-FM4U-BMint-2-Desktop/dp/B00EONR674' + '?tag=Courserytools-20');
                expect(AmazonUtils.createCleanAffiliateURL('https://www.amazon.com/MintBox-IPC-D2x2-C3337NL-H500-WB-XLM-FM4U-BMint-2-Desktop/dp/B00EONR674/')).toEqual('https://www.amazon.com/MintBox-IPC-D2x2-C3337NL-H500-WB-XLM-FM4U-BMint-2-Desktop/dp/B00EONR674' + '?tag=Courserytools-20');
                expect(AmazonUtils.createCleanAffiliateURL('https://www.amazon.com/CompuLab-fit-Headless-Display-Emulator/dp/B00FLZXGJ6/ref=pd_sim_147_3?_encoding=UTF8&psc=1&refRID=6B8NRRYW1V0VH98QZV6J')).toEqual('https://www.amazon.com/CompuLab-fit-Headless-Display-Emulator/dp/B00FLZXGJ6' + '?tag=Courserytools-20');
                expect(AmazonUtils.createCleanAffiliateURL('https://www.amazon.com/dp/B01LWW2CGN?psc=1')).toEqual('https://www.amazon.com/dp/B01LWW2CGN' + '?tag=Courserytools-20');
                expect(AmazonUtils.createCleanAffiliateURL('https://www.amazon.com/dp/B01LWW2CGN', '')).toEqual('https://www.amazon.com/dp/B01LWW2CGN' + '?tag=Courserytools-20');
                ...
                expect(AmazonUtils.createCleanAffiliateURL('http://www.amazon.com/dp/B0015T963C', '')).toEqual('http://www.amazon.com/dp/B0015T963C' + '?tag=Courserytools-20');
                ...
                expect(AmazonUtils.createCleanAffiliateURL('http://www.amazon.com/gp/product/glance/B0015T963C')).toEqual('http://www.amazon.com/gp/product/glance/B0015T963C' + '?tag=Courserytools-20');
                expect(AmazonUtils.createCleanAffiliateURL('https://www.amazon.com/promocode/AOBPUN3EX2D89')).toEqual('https://www.amazon.com/promocode/AOBPUN3EX2D89' + '?tag=Courserytools-20');
        ...
        describe('Test Append Affiliate Tag Scenarios', function () {
            it('Append Affiliate tag to Amazon URL', function () {
                expect(AmazonUtils.addAffiliateTag('https://www.amazon.com/MintBox-IPC-D2x2-C3337NL-H500-WB-XLM-FM4U-BMint-2-Desktop/dp/B00EONR674')).toEqual('https://www.amazon.com/MintBox-IPC-D2x2-C3337NL-H500-WB-XLM-FM4U-BMint-2-Desktop/dp/B00EONR674' + '?tag=Courserytools-20');
                expect(AmazonUtils.addAffiliateTag('https://www.amazon.com/MintBox-IPC-D2x2-C3337NL-H500-WB-XLM-FM4U-BMint-2-Desktop/dp/B00EONR674/')).toEqual('https://www.amazon.com/MintBox-IPC-D2x2-C3337NL-H500-WB-XLM-FM4U-BMint-2-Desktop/dp/B00EONR674/' + '?tag=Courserytools-20');
                expect(AmazonUtils.addAffiliateTag('https://www.amazon.com/CompuLab-fit-Headless-Display-Emulator/dp/B00FLZXGJ6/ref=pd_sim_147_3?_encoding=UTF8&psc=1&refRID=6B8NRRYW1V0VH98QZV6J')).toEqual('https://www.amazon.com/CompuLab-fit-Headless-Display-Emulator/dp/B00FLZXGJ6/ref=pd_sim_147_3' + '?tag=Courserytools-20' + '&_encoding=UTF8&psc=1&refRID=6B8NRRYW1V0VH98QZV6J');
                expect(AmazonUtils.addAffiliateTag('https://www.amazon.com/dp/B01LWW2CGN?psc=1')).toEqual('https://www.amazon.com/dp/B01LWW2CGN' + '?tag=Courserytools-20&psc=1');
                expect(AmazonUtils.addAffiliateTag('https://www.amazon.com/dp/B01LWW2CGN', '')).toEqual('https://www.amazon.com/dp/B01LWW2CGN' + '?tag=Courserytools-20');
                expect(AmazonUtils.addAffiliateTag('http://www.amazon.com/Kindle-Wireless-Reading-Display-Generation/dp/B0015T963C', 'mytag')).toEqual('http://www.amazon.com/Kindle-Wireless-Reading-Display-Generation/dp/B0015T963C' + '?tag=mytag');
                expect(AmazonUtils.addAffiliateTag('http://www.amazon.com/dp/B0015T963C', '')).toEqual('http://www.amazon.com/dp/B0015T963C' + '?tag=Courserytools-20');
                expect(AmazonUtils.addAffiliateTag('http://www.amazon.com/gp/product/B0015T963C', 'producturl-tag')).toEqual('http://www.amazon.com/gp/product/B0015T963C' + '?tag=producturl-tag');
                expect(AmazonUtils.addAffiliateTag('http://www.amazon.com/gp/product/glance/B0015T963C')).toEqual('http://www.amazon.com/gp/product/glance/B0015T963C' + '?tag=Courserytools-20');
                expect(AmazonUtils.addAffiliateTag('https://www.amazon.com/promocode/AOBPUN3EX2D89')).toEqual('https://www.amazon.com/promocode/AOBPUN3EX2D89' + '?tag=Courserytools-20');
                expect(AmazonUtils.addAffiliateTag('https://www.amazon.com/promocode/AOBPUN3EX2D89', 'promo-tag')).toEqual('https://www.amazon.com/promocode/AOBPUN3EX2D89' + '?tag=promo-tag');
            });
        });
    });
